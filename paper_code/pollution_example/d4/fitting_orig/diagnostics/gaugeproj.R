...
axes3d()
# view3d(userMatrix = usermat,zoom=0.9)
# snapshot3d("fittedgauge_proj_1.png",width=500,height=500, webshot = TRUE)
view3d(userMatrix = usermat,zoom=0.8)
htmlwidgets::saveWidget(rglwidget(),file="fittedgauge_proj_1.html")
webshot2::webshot("fittedgauge_proj_1.html", "fittedgauge_proj_1.png", vwidth = 500, vheight = 500)
...
webshot2::webshot("fittedgauge_proj_2.html", "fittedgauge_proj_2.png", vwidth = 500, vheight = 500)
# file.remove("fittedgauge_proj_2.html")
...
webshot2::webshot("fittedgauge_proj_3.html", "fittedgauge_proj_3.png", vwidth = 500, vheight = 500)
# file.remove("fittedgauge_proj_3.html")
...
webshot2::webshot("fittedgauge_proj_4.html", "fittedgauge_proj_4.png", vwidth = 500, vheight = 500)
# file.remove("fittedgauge_proj_4.html")
