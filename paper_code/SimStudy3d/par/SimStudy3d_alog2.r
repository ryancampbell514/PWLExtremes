...
mygauge = function(xyz,par){
  # par, length 3
  geometricMVE::gauge_rvad_all3d(xyz,par,theta2=0,theta3=0,theta13=0,theta123=0)
}
...
load("~/Dropbox/phd_research/pw_lin_gauge/SimStudy_3d/quantiles/alog2_quantiles.Rdata")
...
for(k in 1:nrep){
  ...
  fit<-fit.geometricMVE.3d.fixedshape(r = rexc, w=wexc, r0w = r0w, gfun = mygauge,
                                      init.val = rep(0.5,3),
